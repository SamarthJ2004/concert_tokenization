...
import { MapPin, ArrowLeft, Users, DollarSign, Clock, Target, ShoppingCart, Wallet } from "lucide-react"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Card>
                <CardContent className="p-4 text-center">
                  ...
                  <div className="text-2xl font-bold">${property.totalSale.toLocaleString()}</div>
              ...
              <Card>
                <CardContent className="p-4 text-center">
                  ...
                  <div className="text-2xl font-bold">{property.maturityTime}</div>
                  <div className="text-sm text-muted-foreground">Maturity Time</div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-4 text-center">
                  ...
                  <div className="text-2xl font-bold">${property.ticketSale}</div>
                  <div className="text-sm text-muted-foreground">Ticket Sale</div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-4 text-center">
                  ...
                  <div className="text-2xl font-bold">{property.totalInvestors}</div>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        <div className="text-xl font-semibold">${property.pricePerToken}</div>
                      </div>
                      <div>
                        <div className="text-sm text-muted-foreground">Expected APY</div>
                        <div className="text-xl font-semibold text-accent">{property.apy}%</div>
                      </div>
                      <div>
                        <div className="text-sm text-muted-foreground">Total Tokens</div>
                        <div className="text-xl font-semibold">{property.totalTokens.toLocaleString()}</div>
                      </div>
                      <div>
                        <div className="text-sm text-muted-foreground">Sold Tokens</div>
                        <div className="text-xl font-semibold">{property.soldTokens.toLocaleString()}</div>
                      </div>
                      <div>
                        <div className="text-sm text-muted-foreground">Available</div>
                        <div className="text-xl font-semibold">{availableTokens.toLocaleString()}</div>
                      </div>
                      <div>
                        <div className="text-sm text-muted-foreground">Property Area</div>
                        <div className="text-xl font-semibold">{property.area.toLocaleString()} sq ft</div>
                      </div>
                    </div>
              ...
              <TabsContent value="investors" className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Current token holders and their investments</CardDescription>
                  </CardHeader>
                  <CardContent>
                        ...
                        <div key={index} className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                          <div className="flex items-center gap-3">
                            <div className="w-8 h-8 bg-accent/20 rounded-full flex items-center justify-center">
                              <span className="text-sm font-medium">{investor.ens.charAt(0).toUpperCase()}</span>
                            </div>
                            <div>
                              <div className="font-medium">{investor.ens}</div>
                              <div className="text-sm text-muted-foreground">{investor.tokens} tokens</div>
                            </div>
                          </div>
                          <div className="text-right">
                            <div className="font-semibold">${investor.investment.toLocaleString()}</div>
                            <div className="text-sm text-muted-foreground">
                              {((investor.tokens / property.totalTokens) * 100).toFixed(2)}%
                            </div>
                          </div>
                        </div>
                      ))}
                  ...
                  <CardContent>
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        <div className="font-semibold">{property.propertyDetails.propertyType}</div>
                      </div>
                      <div>
                        <div className="text-sm text-muted-foreground">Year Built</div>
                        <div className="font-semibold">{property.propertyDetails.yearBuilt}</div>
                      </div>
                      <div>
                        <div className="text-sm text-muted-foreground">Floors</div>
                        <div className="font-semibold">{property.propertyDetails.floors}</div>
                      </div>
                      <div>
                        <div className="text-sm text-muted-foreground">
                        ...
                        <div className="font-semibold">
                          {property.propertyDetails.units || property.propertyDetails.tenants}
                        </div>
                      </div>
                      <div>
                        <div className="text-sm text-muted-foreground">Occupancy Rate</div>
                        <div className="font-semibold">{property.propertyDetails.occupancyRate}%</div>
                      </div>
                      <div>
                        <div className="text-sm text-muted-foreground">Monthly Rent</div>
                        <div className="font-semibold">${property.propertyDetails.monthlyRent.toLocaleString()}</div>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            {property.status === "active" && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Purchase tokens to own a share of this property</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                  ...
                  {purchaseAmount && (
                    <div className="p-3 bg-muted rounded-lg">
                      ...
                      <div className="text-2xl font-bold">
                        ${(Number.parseInt(purchaseAmount) * property.pricePerToken).toLocaleString()}
                      </div>
                    </div>
                  )}
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">
                    ${(property.totalTokens * property.pricePerToken).toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between">
