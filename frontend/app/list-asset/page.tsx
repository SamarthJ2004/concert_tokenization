  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Your property is now being listed on the marketplace and will be available for investors soon.",
        duration: 5000,
      })
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Tokenize your real-world asset and make it available for fractional investment.
            </p>
          </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Provide details about your asset to create tokenized investment opportunities.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* File Upload */}
                <div className="space-y-2">
                  <Label htmlFor="verification">Ownership Verification Documents</Label>
                      ...
                      {uploadedFile ? (
                        ...
                        <div className="flex flex-col items-center gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">PDF, DOC, or image files (max 10MB)</p>
                          </div>
                        </div>
                      )}
                    </label>
