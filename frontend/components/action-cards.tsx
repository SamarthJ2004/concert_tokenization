...
import { Building2, Coins, ArrowUpRight, Shield, Users, BarChart3 } from "lucide-react"
    ...
    <section className="py-24 bg-muted/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-balance mb-4">Choose Your Path</h2>
