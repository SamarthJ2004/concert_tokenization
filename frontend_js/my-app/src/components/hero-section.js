    ...
    <section className="relative min-h-[80vh] flex items-center justify-center grid-pattern">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <button
            type="button"
            className="inline-flex items-center justify-center gap-2 text-lg px-8 py-6 rounded-md bg-primary text-primary-foreground shadow-sm transition hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
          ...
          <button
            type="button"
            className="inline-flex items-center justify-center text-lg px-8 py-6 rounded-md border border-input bg-transparent text-foreground shadow-sm transition hover:bg-accent/10 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
